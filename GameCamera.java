...
//    public static final float CAM_NORM_FOV = 80f; // FOV for NOT sprinting 
    ...
    public static final float CAM_ALTERNATE_TRANSITION_SPEED = 200f;
    public static final float CAM_MAX_FOV_TRANSITION = 180f;
...
//        }
    ...
    public boolean enable2D(float dt) {
        /**
         * One of the pre-requsuites for our 2D --> 3D Transition is that our camera's FOV expands for dramatic effect
         * 
         * @param dt deltaTime to increment our FOV
         * 
         * @return boolean True that FOV has finished expanding
         */
        this.camera.fieldOfView += dt * GameCamera.CAM_ALTERNATE_TRANSITION_SPEED;
        this.camera.update();
        return this.camera.fieldOfView > GameCamera.CAM_MAX_FOV_TRANSITION;
    }
    
    public boolean disable2D(float dt) {
        /** 
         * One of the pre-requisites for 3D --> 2D, epic transitions
         * 
         * @param dt deltaTime to decrease POV
         * 
         * @return boolean True that FOV has finished decreasing
         */
        this.camera.fieldOfView -= dt * GameCamera.CAM_ALTERNATE_TRANSITION_SPEED;
        this.camera.update();
        return this.camera.fieldOfView < GameCamera.CAM_NORM_FOV;
    }
