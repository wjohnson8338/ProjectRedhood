...
//        }
    ...
    public static float getDistance(Vector3 pos_one, Vector3 pos_two) {
        return (float) Math.sqrt(Math.pow((pos_two.x - pos_one.x), 2) + Math.pow((pos_two.y - pos_one.y), 2) + Math.pow((pos_two.z - pos_one.z), 2));
    }
}
